...
Completed_courses_list = ["BIOLOGY", "CHEMISTRY", "CALCULUS", "SPANISH ll", "WORLD HISTORY"]
Credit_hours_lists = [3, 3, 3, 3]
GPA_history_lists = [3.2, 3.6, 3.4, 3.7]

#Contact Info
Emerceny_contact_tuple = ("Hannah Smith (Mom) - 704-555-0199")
...
Total_credits = sum(Credit_hours_lists) #used sum tool to calculate all credit hours
...
print(f"Emergency Contact: {Emerceny_contact_tuple}")
